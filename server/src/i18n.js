...
const TEXTOS = {
  es: {
    ...
    ask_when: '¿Para cuándo? Puedes decir "mañana", "el viernes", "15/10" o "sin fecha".',
  ...
  de: {
    ...
    ask_when: 'Bis wann? Du kannst "morgen", "am Freitag", "15/10" oder "ohne Datum" sagen.',
  ...
  pt: {
    ...
    ask_when: 'Para quando? Podes dizer "amanhã", "sexta", "15/10" ou "sem data".',
